...
from confluencia_circrna.core.circrna_rl_abm import (
    ...
    optimize_circrna_combination,
    compare_with_baseline,
)
from confluencia_circrna.core.tme_simulation import (
    CellPopulation,
    Cytokine,
    CheckpointStatus,
    SpatialCompartment,
...
from confluencia_circrna.core.multi_drug_combination import (
    DrugInfo,
    DRUG_DATABASE,
    CombinationResult,
    DosingRegimen,
...
from confluencia_circrna.core.patient_stratification import (
    BiomarkerThresholds,
    PatientStratum,
    PATIENT_STRATA,
...
from confluencia_circrna.core.adaptive_dosing import (
    DoseConstraints,
    MonitoringPoint,
    DoseAdjustment,
    AdaptiveStrategy,
...
__all__ = [
    ...
    "get_cross_species_bsj",
    "add_conservation_to_features",
    # circrna_rl_abm - NEW (RL + ABM integration)
    "PatientProfile",
    "RLABMConfig",
    "CircRNAState",
    "ABMRewardComponents",
    ...
    "optimize_circrna_combination",
    "compare_with_baseline",
    # tme_simulation - NEW (advanced TME simulation)
    "CellPopulation",
    "Cytokine",
    "CheckpointStatus",
    "SpatialCompartment",
    ...
    "simulate_tme",
    "classify_tme",
    # multi_drug_combination - NEW (drug combination optimization)
    "DrugInfo",
    "DRUG_DATABASE",
    "CombinationResult",
    "DosingRegimen",
    ...
    "optimize_combination",
    "get_top_combinations",
    # patient_stratification - NEW (patient subgroup classification)
    "BiomarkerThresholds",
    "PatientStratum",
    "PATIENT_STRATA",
    "StratificationResult",
    ...
    "get_stratum_summary",
    "stratify_patient",
    # adaptive_dosing - NEW (real-time dose adjustment)
    "DoseConstraints",
    "MonitoringPoint",
    "DoseAdjustment",
    "AdaptiveStrategy",
