...
Status: Validated against literature values (4.1% error on half-lives), but independent experimental confirmation needed. The endosomal escape parameter shows 158% error, reflecting uncertainty in this rate-limiting step.
